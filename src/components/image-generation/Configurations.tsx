    ...
    <TooltipProvider>
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          <fieldset className="grid gap-6 p-6 bg-background rounded-lg border">
            <legend className="text-sm -ml-4 px-1 font-medium">Setting</legend>
                  ...
                  <FormLabel className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p>Propmt guidence for generated image.</p>
                        </TooltipContent>
                      </Tooltip>
                    </div>
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p>
                            ...
                            28-50 for dev model and 1-4 for schell model.
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </div>
